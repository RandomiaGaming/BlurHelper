namespace BlurHelper
{
    public sealed class BlurPath
    {
        ...
        public BlurPath(uint frameIndex, System.Collections.Generic.List<KeyFrame> keyFrames)
        {
            FrameIndex = frameIndex;
            if (keyFrames is null)
            {
                throw new System.Exception("keyFrames cannot be null. Use empty list instead.");
            }
